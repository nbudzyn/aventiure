...
import de.nb.aventiure2.data.world.entity.creature.CreatureFactory;
import de.nb.aventiure2.data.world.entity.object.ObjectFactory;
import de.nb.aventiure2.data.world.invisible.InvisibleFactory;
import de.nb.aventiure2.data.world.location.ILocatableGO;
import de.nb.aventiure2.data.world.location.LocationSystem;
import de.nb.aventiure2.data.world.location.RoomFactory;
import de.nb.aventiure2.data.world.memory.IHasMemoryGO;
import de.nb.aventiure2.data.world.player.SpielerCharakter;
import de.nb.aventiure2.data.world.player.SpielerCharakterFactory;
import de.nb.aventiure2.data.world.storingplace.IHasStoringPlaceGO;
import de.nb.aventiure2.data.world.storingplace.StoringPlaceType;
import de.nb.aventiure2.data.world.time.AvDateTime;
import de.nb.aventiure2.german.base.Nominalphrase;

import static com.google.common.base.Predicates.not;
import static com.google.common.collect.ImmutableList.toImmutableList;
import static de.nb.aventiure2.data.world.gameobjectstate.GameObjectState.AUFMERKSAM;
...
import static de.nb.aventiure2.data.world.gameobjectstate.GameObjectState.NOCH_NICHT_BEGONNEN;
import static de.nb.aventiure2.data.world.gameobjectstate.GameObjectState.NORMAL;
import static de.nb.aventiure2.data.world.gameobjectstate.GameObjectState.UNAUFFAELLIG;
import static de.nb.aventiure2.data.world.gameobjectstate.GameObjectStateList.sl;
