...
public enum VerbSubjObj implements VerbMitValenz, SemPraedikatMitEinerObjektleerstelle {
    ...
    BEOBACHTEN("beobachten", AKK, "beobachte", "beobachtest",
            "beobachtet", "beobachtet",
            Perfektbildung.HABEN, "beobachtet"),
    ...
    LOCKEN("locken", AKK, "locke", "lockst", "lockt",
            "lockt", Perfektbildung.HABEN, "gelockt"),
    ...
    VERSCHEUCHEN("verscheuchen", AKK, "verscheuche", "verscheuchst", "verscheucht",
            "verscheucht", Perfektbildung.HABEN, "verscheucht"),
    ...
    ANLOCKEN(LOCKEN, AKK, "an", Perfektbildung.HABEN),
