...
public class MeaningFactory {
    ...
    public GameObject createStoryWeb() {
        return new StoryWeb(db, world, locationSystem, spatialConnectionSystem);
    }
    ...
    private static class StoryWeb extends GameObject
        ...
        public StoryWeb(final AvDatabase db, final World world,
            ...
            storyWebComp = addComponent(new StoryWebComp(
                    db, world, locationSystem, spatialConnectionSystem,
                    Story.FROSCHKOENIG, Story.RAPUNZEL));
            reactionsComp = addComponent(new StoryWebReactionsComp(db, world, storyWebComp));
        }
